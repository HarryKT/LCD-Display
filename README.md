...
If this is your first time writing and running a Python program, you might want to read [How to Write and Run a Python Program on the Raspberry Pi](https://www.circuitbasics.com/?p=214283){:target="_blank" rel="noopener"}, which will explain everything you need to know to run the examples below.
